...
const STUDY_METHODS = [
  ...
  { keywords: ["컴공", "코딩", "컴퓨터", "개발", "소프트웨어", "IT"], title: "컴공과 이진법 공부법", desc: "아는 것(1)과 모르는 것(0)을 확실히 구분하려다 0만 남음." },
  { keywords: ["과학", "양자", "슈뢰딩거", "물리"], title: "슈뢰딩거의 공부법", desc: "시험지를 열기 전까지 나는 합격과 불합격 상태가 공존한다." },
  ...
  { keywords: ["수학", "통계", "운", "회계"], title: "피타고라스 공부법", desc: "성적² = 노력² + 운²  …결국 운이 더 크다." },
  { keywords: ["넷플릭스", "유튜브", "영화", "취미", "방송"], title: "타노스 공부법", desc: "반만 외운다." },
  { keywords: ["운동", "헬스", "근육", "체육", "달리기"], title: "근성장 공부법", desc: "공부도 근성장처럼 휴식이 제일 중요하다며 하루 종일 누워 있음." },
  ...
  { keywords: ["간호", "의학", "응급", "의예"], title: "심폐소생술 공부법", desc: "이미 사망한 내 성적에 심폐소생술을 시도하지만 골든타임을 놓침." },
  { keywords: ["법학", "법", "유예", "법대"], title: "집행유예 공부법", desc: "이번 학기 성적 처벌을 다음 학기로 유예해달라고 기도함." },
  ...
  { keywords: ["환경", "식물", "원예", "농사", "농학", "식품"], title: "배추 공부법", desc: "포기한다." },
  { keywords: ["환경", "식물", "원예", "농사","농학", "식품"], title: "수박 공부법", desc: "겉핥기 식으로 첫장과 맨끝장만 본다." },
  ...
  { keywords: ["전기", "전류", "감전"], title: "감전 공부법", desc: "전류는 눈에 안 보이니까 직접 느껴본다." },
  { keywords: ["전자", "디버깅", "기도"], title: "기도메타 공부법", desc: "안 될 땐 논리 말고 전원 껐다 켜고 기도한다." },
  { keywords: ["우주", "항공", "무한"], title: "우주는원래그래 공부법", desc: "이해 안 되는 건 우주가 원래 그런 거라 넘긴다." },
  { keywords: ["춤", "무용", "댄스", "안무"], title: "삘받기 공부법", desc: "이론은 모르겠고 삘 오면 그게 정답이다." },
  { keywords: ["공학", "공대", "공과", "기도"], title: "기도메타 공부법", desc: "시연 전에는 논리보다 기도가 더 중요하다." },
